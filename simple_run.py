...
model_file = 'saved_models/u2net_2021-12-16_epoch_19_train_0.7557503520919565_test_0.7732233350837467.pth'
# filename = "test.jpg"
# filename = "http://s3.aidata.me/ailab/u_2_net_new/tsum.com/botinki/7334578_01_640_square.jpg"

image_name = '197035__120370470_23845899106150138_7435532733972545474_n.jpg'
filename = "creatives/" + image_name
input_size = 500
bg_color = (220, 30, 60)
...
def main():
    ...
    # сохраняем результат
    save_output(pillow_image, mask, image_name[:-3] + "result.png")
